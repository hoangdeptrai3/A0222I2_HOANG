...
public class ProductRepository implements IProductRepository {
    ...
    private final String ADD_NEW = "insert into product(`name`,price,quantity,color) values (?,?,?,?);";
    private final String UPDATE_BY_ID = "update product set `name` = ?,price = ?,quantity = ?,color = ? where id = ?";
    ...
    public List<Product> search(String name){
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                int quantity = resultSet.getInt("quantity");
                String color = resultSet.getString("color");
                list.add(new Product(id,nameSearch,price,quantity,color));
            }
